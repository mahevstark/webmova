...
export default function Employee() {
  ...
  const onAddEmployeeDelete = (employee) => {
    console.log("Delete from AddEmploye dialog:", employee);
    // Specific logic for AddEmploye deletion
  ...
  return (
    <Layout page={page}>
      <AddEmploye
        ...
        onDelete={onAddEmployeeDelete} // Function to handle the delete action
      />
      <DeleteConfirmation
